...
Route::get('/ice/{id}/start', ['as' => 'ice.start', 'uses' => 'IceController@iceStart']);
Route::get('/ice/{id}/stop', ['as' => 'ice.stop', 'uses' => 'IceController@iceStop']);
...
Route::get('/mount/{id}/enable', ['as' => 'mount.start', 'uses' => 'MountController@mountStart']);
Route::get('/mount/{id}/disable', ['as' => 'mount.stop', 'uses' => 'MountController@mountStop']);
